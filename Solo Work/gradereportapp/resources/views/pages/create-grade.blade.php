    ...
    <div class="container">
        @component('components.card')
            ...
            @slot('cardBody')
                ...
                <form method="post" action="{{ action('GradesController@store') }}" enctype="multipart/form-data">
                    @csrf

                    <div class="row form-group">
                        <label class="text-light col-md-2 col-form-label text-md-right" for="name">Name <span class="d-none d-md-inline">:</span></label>
                        <div class="col-md-9">
                            <input class="form-control" type="text" name="name" id="name" placeholder="Mary Smith" value="{{ old('name') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="number" name="grade" id="grade" placeholder="97" min="0" step="any" value="{{ old('grade') }}" required>
                        </div>
                    </div>
                    @if(isset($errors) && count($errors) > 0)
